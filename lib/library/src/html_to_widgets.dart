...
import 'package:graphical_abstract/library/src/attributes.dart';
import 'package:graphical_abstract/library/src/extension/int_extensions.dart';
...
//iterate over multiple childrens
  ...
  Widget _parseHeadingElement(
    ...
    return RichText(text: TextSpan(children: delta, style: TextStyle(fontSize: level.getHeadingSize, fontWeight: FontWeight.bold)..merge(level.getHeadingStyle(customStyles))));
  }
...
// Function to download and save an image from a URL
  ...
  Future<Widget> _parseDeltaElement(dom.Element element) async {
    ...
    return Wrap(alignment: WrapAlignment.start, children: [RichText(text: TextSpan(children: delta)), ...childNodes]);
  }
